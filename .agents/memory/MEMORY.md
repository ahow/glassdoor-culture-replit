...
- [Fundamental/valuation analyses](fundamental-valuation-analyses.md) — freeze memberships first; PIT TTM filing-date rules; use NI/mcap E/P (adjusted price ÷ reported EPS is split-broken).
